...
const mestreTools = {
  ...
  abrir_pasta_logs: {
    ...
    command: `$project="C:\\Users\\Jeanc\\MestreDoPC_V7"; $logDir=Join-Path $project "logs"; New-Item -ItemType Directory -Force -Path $logDir | Out-Null; Start-Process $logDir; Write-Host "Pasta de logs aberta: $logDir" -ForegroundColor Green`,
